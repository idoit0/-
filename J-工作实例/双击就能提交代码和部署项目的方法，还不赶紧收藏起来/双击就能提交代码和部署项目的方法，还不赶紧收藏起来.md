...
## 题目  
   ...
   双击就能提交代码和部署项目的方法，还不赶紧收藏起来
---

## 简介：
今天我们的主角是批处理bat脚本。一种简化的脚本语言，主要应用于Windows系统和Dos中。
本文利用简单的几行代码，带你实现代码自动提交，项目轻松运行。希望能帮助到你。
...
``` sh
  ...
  git push
```
  用这个脚本，我们只要双击 FilePush.bat 批处理文件，即可完成自动提交。省去写重复的代码提交命令。
